...
const FABRIC_CLOUD_COLUMNS = new Set([
  ...
  'width_cm', 'shrinkage_pct', 'shrinkage_warp_pct', 'shrinkage_weft_pct',
  'weight_gsm_post', 'width_cm_post', 'weight_gsm_tumble',
  'measured_weft_tumble_pct', 'measured_warp_tumble_pct',
  'stretch_pct', 'mill_id', 'lead_time_days',
  ...
  const seeds = [
    {
      ...
      width_cm: 180,
      shrinkage_warp_pct: 5.0,
      shrinkage_weft_pct: 4.5,
      stretch_pct: 0,
      color_id: 'PFD',
    ...
    },
    {
      ...
      width_cm: 81,
      shrinkage_warp_pct: 9.0,
      shrinkage_weft_pct: 6.0,
      stretch_pct: 0,
      color_id: 'Slate',
