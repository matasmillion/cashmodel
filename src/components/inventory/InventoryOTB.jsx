// Open-to-Buy — quarterly planned receipts $ per class. Phase 5 replaces this stub.

export default function InventoryOTB() {
  return (
    <Placeholder title="Open-to-Buy" subtitle="Quarterly planned receipts $ per class. Committed debited by open POs." />
  );
}
