  ...
  return (
    <div>
      <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 16 }}>
        <div>
          <h3 style={{ color: FR.slate, fontFamily: "'Cormorant Garamond', serif", fontSize: 20, margin: 0 }}>Fabrics</h3>
          <p style={{ color: FR.stone, fontSize: 12, margin: '4px 0 0' }}>
            Composition, weight, hand, swatch, mill, lead time — every base fabric the line uses.
          </p>
        </div>
        <button disabled
      ...
      <div style={{ padding: '60px 24px', textAlign: 'center', background: FR.salt, border: `1px dashed ${FR.sand}`, borderRadius: 8 }}>
        ...
        <div style={{ fontSize: 12, color: FR.stone, marginTop: 8, maxWidth: 440, marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.6 }}>
          Fabrics become a first-class atom in a later phase. Tech packs will reference fabric IDs instead of inline text, and every PO will snapshot the exact version used.
        </div>
      </div>
    </div>
  );
